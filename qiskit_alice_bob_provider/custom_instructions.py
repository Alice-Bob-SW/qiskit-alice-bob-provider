...
from qiskit_alice_bob_provider.custom_functions import (
    substitute_node_with_dag_custom,
)
...
DAGCircuit.substitute_node_with_dag = substitute_node_with_dag_custom
